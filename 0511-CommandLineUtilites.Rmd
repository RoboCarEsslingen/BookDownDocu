...
Tawn Kramer wrote a little tool to do transfer learning which can be downloaded from https://gist.github.com/tawnkramer/5fa63a805e045504c4e56004e4f93e42

There is a python file ```train_imagenet.py``` which is engaged with the following command
