...
```
then type the password of the pi
copies the file ```mycar/manage.py``` to the current location
...
## delete recoreded data

The training data is being stored in the folder /mycar/tub. once you want to get rid of the data use the following command
