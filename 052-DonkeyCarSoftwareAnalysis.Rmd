...
so the cycle starts with `False` and can be toggled by pressing the button **B** on the WiiU controller. How to indicate the recording mode with an LED is described in \@ref(LedIndicatingRecordingMode)     